...
const PAYMENT_API = {
    config: {
        apiKey: 'LXZ_d7347e2859884015',  // API KEY TERBARU
    ...
    async createInvoice(amount) {
        try {
            ...
            if (data.success && data.invoice_id) {
                // BUAT QRIS MANUAL dari payment link (PASTI MUNCUL)
    ...
    // 4. METODE WITHDRAW (fallback jika API error)
